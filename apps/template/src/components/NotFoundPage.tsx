...
export function NotFoundPage() {
  ...
  return (
    <div className="flex h-full min-h-[60vh] flex-col items-center justify-center gap-4 p-8 text-center">
      ...
      <h1 className="text-2xl font-semibold text-gray-700">{L('SchollApp::PageNotFound', 'Sayfa bulunamadı')}</h1>
      <p className="text-gray-500">{L('SchollApp::PageNotFoundMessage', 'Aradığınız sayfa mevcut değil veya taşınmış olabilir.')}</p>
      <Link
        to="/"
